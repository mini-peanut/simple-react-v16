...
// Use flags to signal movementX/Y has already been set
  ...
  var eventResponderContext = {
    dispatchEvent: function (possibleEventObject, listener, discrete) {
  ...
  var lastDiscreteEventTimeStamp = 0;

  function shouldflushDiscreteUpdates(timeStamp) {
...

  {
    ...
    ReactStrictModeWarnings.recordUnsafeLifecycleWarnings = function (fiber, instance) {
      ...
      if (typeof instance.componentWillUpdate === 'function' && instance.componentWillUpdate.__suppressDeprecationWarning !== true || typeof instance.UNSAFE_componentWillUpdate === 'function') {
        unsafeLifecyc
        les.push('UNSAFE_componentWillUpdate');
      }
...
// separate callback per expiration time.
  ...
  function flushDiscreteUpdates$1() {
  ...
  function unbatchedUpdates(fn, a) {
    if (workPhase !== BatchedPhase && workPhase !== FlushSyncPhase && workPhase !== BatchedEventPhase) {
...
// wraps anothers' updates/effects
  ...
  function warnIfNotScopedWithMatchingAct(fiber) {
    {
      if (ReactCurrentActingRendererSigil.current !== null &&
  ...
  function warnIfNotCurrentlyActingUpdatesInDEV(fiber) {
    {
      if (workPhase === NotWorking && ReactCurrentActingRendererSigil.current !== ReactActingRendererSigil) {
